...
export const INITIAL_INVENTORY = [
  ...
  { id: 'kmno4', name: 'Thuốc Tím (KMnO4)', type: ITEM_TYPE.CHEMICAL, state: PHYSICAL_STATE.SOLID, icon: <CircleDot className="w-8 h-8 text-purple-600 drop-shadow-sm" fill="#9333ea" stroke="none" />, desc: 'Chất oxy hóa mạnh, màu tím đậm đặc trưng.' },
  { id: 'nacl', name: 'Sodium Cloride (NaCl)', type: ITEM_TYPE.CHEMICAL, state: PHYSICAL_STATE.SOLID, icon: <Square className="w-8 h-8 text-white drop-shadow-sm" fill="#ffffff" stroke="#cbd5e1" />, desc: 'Natri Clorua - Muối ăn.' },
  ...
  { id: 'na2co3', name: 'Sodium Carbonate (Na2CO3)', type: ITEM_TYPE.CHEMICAL, state: PHYSICAL_STATE.SOLID, icon: <Square className="w-8 h-8 text-slate-100 drop-shadow-sm" fill="#f1f5f9" stroke="#e2e8f0" />, desc: 'Natri Cacbonat.' },
  ...
  // ==========================================
  { id: 'water', name: 'Nước (H2O)', type: ITEM_TYPE.CHEMICAL, state: PHYSICAL_STATE.LIQUID, icon: <Droplet className="w-8 h-8 text-blue-500 drop-shadow-sm" fill="#3b82f6" stroke="none" />, desc: 'Dung môi phổ biến.' },
  { id: 'agno3', name: 'Bạc Nitrate (AgNO3)', type: ITEM_TYPE.CHEMICAL, state: PHYSICAL_STATE.LIQUID, icon: <Droplet className="w-8 h-8 text-blue-200 drop-shadow-sm" fill="#e2e8f0" stroke="none" />, desc: 'Bạc Nitrat - Dung dịch trong suốt.' },
  { id: 'bacl2', name: 'Bari Chloride (BaCl2)', type: ITEM_TYPE.CHEMICAL, state: PHYSICAL_STATE.LIQUID, icon: <Droplet className="w-8 h-8 text-blue-100 drop-shadow-sm" fill="#f1f5f9" stroke="none" />, desc: 'Bari Clorua.' },
  { id: 'na2so4', name: 'Sodium Sulfate (Na2SO4)', type: ITEM_TYPE.CHEMICAL, state: PHYSICAL_STATE.LIQUID, icon: <Droplet className="w-8 h-8 text-blue-500/20 drop-shadow-sm" fill="#dbeafe" stroke="none" />, desc: 'Natri Sulfat.' },
  { id: 'cuso4', name: 'Đồng (II) Sulfate (CuSO4)', type: ITEM_TYPE.CHEMICAL, state: PHYSICAL_STATE.LIQUID, icon: <Droplet className="w-8 h-8 text-blue-600 drop-shadow-sm" fill="#2563eb" stroke="none" />, desc: 'Đồng(II) Sulfat - Dung dịch màu xanh dương.' },
  { id: 'h2c2o4', name: 'Oxalic Acid (H2C2O4)', type: ITEM_TYPE.CHEMICAL, state: PHYSICAL_STATE.LIQUID, icon: <Droplet className="w-8 h-8 text-slate-400 drop-shadow-sm" fill="#f8fafc" stroke="none" />, desc: 'Axit Oxalic.' },
